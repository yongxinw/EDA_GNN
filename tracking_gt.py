...
def main(info, timer):
    ...
    # detection = MakeCell(np.loadtxt("/hdd/yongxinw/MOT17/label/test/MOT17-{}-{}/det/det.txt".format(info[0], info[1])))
    # manual_init = MakeCell(np.loadtxt("/hdd/yongxinw/MOT17/label/test/MOT17-{}-{}/det/det.txt".format(info[0], info[1])))
