...
# tracks = np.loadtxt("/hdd/yongxinw/MOT17/experiments/train_mot15/Sep-25-at-14-32.txt")

def visualize(sequence, exp_dir, image_dir):

    tracks = np.loadtxt(os.path.join(exp_dir, "{}.txt".format("Sep-25-at-21-04")))
